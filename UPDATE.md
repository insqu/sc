...
## Task 7
Interact with your token on Remix. Here is a brief guide on how to do it. 
...
- When that is filled in you can click the At Address button and you should see your contract call functions on the left of the screen
